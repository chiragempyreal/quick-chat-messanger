...
class SignIn extends _react.Component {
  constructor() {
    ...
    _defineProperty(this, "toggleIsremember", () => {
      this.setState({
  ...
  render() {
    ...
    }, "Remember me")), /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
      className: "font-size-sm",
      to: "/reset-password"
    }, "Reset password")), /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
      to: "/Chats",
      className: "btn btn-primary btn-lg btn-block text-uppercase font-weight-semibold"
    }, "Sign in")), /*#__PURE__*/_react.default.createElement("p", null, "Don't have an account?", " ", /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
